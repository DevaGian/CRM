...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { attivazione: @block.attivazione, cu: @block.cu, mensilita: @block.mensilita, q: @block.q, tipo: @block.tipo, tot: @block.tot }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { attivazione: @block.attivazione, cu: @block.cu, mensilita: @block.mensilita, q: @block.q, tipo: @block.tipo, tot: @block.tot }
    assert_redirected_to block_path(assigns(:block))
  end
