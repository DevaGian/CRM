...
class BillingsControllerTest < ActionController::TestCase
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post :create, billing: { address_id: @billing.address_id, agency: @billing.agency, bank: @billing.bank, iban: @billing.iban, payment_mode: @billing.payment_mode, ragione_sociale: @billing.ragione_sociale }
    end
  ...
  test "should update billing" do
    patch :update, id: @billing, billing: { address_id: @billing.address_id, agency: @billing.agency, bank: @billing.bank, iban: @billing.iban, payment_mode: @billing.payment_mode, ragione_sociale: @billing.ragione_sociale }
    assert_redirected_to billing_path(assigns(:billing))
  end
